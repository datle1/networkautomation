...
class yc_loadbalancer_network_models__loadbalancer(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__provider = YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'octavia': {}, 'a10': {}},), default=six.text_type("octavia"), is_leaf=True, yang_name="provider", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='networkautomation:yang:network-functions', defining_module='network-models', yang_type='enumeration', is_config=True)
  ...
  def _set_provider(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'octavia': {}, 'a10': {}},), default=six.text_type("octavia"), is_leaf=True, yang_name="provider", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='networkautomation:yang:network-functions', defining_module='network-models', yang_type='enumeration', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """provider must be of a type compatible with enumeration""",
          'defined-type': "network-models:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'octavia': {}, 'a10': {}},), default=six.text_type("octavia"), is_leaf=True, yang_name="provider", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='networkautomation:yang:network-functions', defining_module='network-models', yang_type='enumeration', is_config=True)""",
        })
