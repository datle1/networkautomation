...
class yc_vlan_config_openconfig_vlan__vlan_config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-vlan - based on the path /vlan-config. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__name = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/vlan', defining_module='openconfig-vlan', yang_type='string', is_config=True)
...
in addition to VLAN parameters associated with interfaces
  """
  __slots__ = ('_path_helper', '_extmethods', '__vlan_config',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__vlan_config = YANGDynClass(base=yc_vlan_config_openconfig_vlan__vlan_config, is_container='container', yang_name="vlan-config", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/vlan', defining_module='openconfig-vlan', yang_type='container', is_config=True)
  ...
  def _set_vlan_config(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_vlan_config_openconfig_vlan__vlan_config, is_container='container', yang_name="vlan-config", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/vlan', defining_module='openconfig-vlan', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vlan_config must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_vlan_config_openconfig_vlan__vlan_config, is_container='container', yang_name="vlan-config", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/vlan', defining_module='openconfig-vlan', yang_type='container', is_config=True)""",
        })
  ...
  _pyangbind_elements = OrderedDict([('vlan_config', vlan_config), ])
